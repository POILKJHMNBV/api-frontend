...
import {invokeInterfaceUsingPOST, queryInterfaceInfoByIdUsingGET} from "@/services/api-backend/interfaceInfoController";
...
const Index: React.FC = () => {
  ...
  const [data, setData] = useState<API.ApiInterfaceInfo>();
